...
##### 甲骨文后台获取参数
- 【操作导航，任意一种均可】
- 1.甲骨文后台=>用户设置>>资源>>API秘钥>>添加API秘钥->(在api右侧三个点处查看参数)
- 2.如没有用户设置的请直接搜用户 点击选择某个用户名 API秘钥>>添加API秘钥->(在api右侧三个点处查看参数)
- 3.不会搜的点击左边菜单身份和安全=>用户=>点击选择某个用户名=>API秘钥>>添加API秘钥）->(在api右侧三个点处查看参数)
